...
//                .contentLength(0)
    ...
    @Test
    public void testHaierPay() {

        Map reqMap = new TreeMap<Object, Object>();
        reqMap.put("notifyUrl", "http://tuan.haier.com/api/pay/notify/wechatpay");
        reqMap.put("orderDesc", "Haier/海尔三门三温区冰箱BCD-x1,Haier海尔特制强劲功能 制冷制热速x1,Haier/海尔空调15米超远距离送风x1,Haier/海尔1P壁挂式冷暖定频空调x1");
        reqMap.put("orderId", "201501121459191000000000002018");
        reqMap.put("payment", "920400");
        reqMap.put("productId", "000000");
        reqMap.put("timeExpire", "20150115073002");
        reqMap.put("sign", "B102879B310896C5EB9576DE224ED618");

        HttpRequest.get("http://uv.haier.com/api/groupbuy/wechatpay/url", reqMap, true)
