...
public class _13_SupplierContact_FreeMarkerUtil {

    private static Configuration cfg;

    private static String classpath=_13_SupplierContact_FreeMarkerUtil.class.getClassLoader().getResource("").getFile();
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO table_name
        String tableName    = "snz_supplier_contacts";
        String model        = "SupplierContact";
        String desc         = "供应商联系方式";
        ...
        addQueryFields.add(ImmutableList.of("id"));
