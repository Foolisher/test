...
public class _10_NewProductStep_FreeMarkerUtil {

    private static Configuration cfg;

    private static String classpath=_10_NewProductStep_FreeMarkerUtil.class.getClassLoader().getResource("").getFile();
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO table_name
        String tableName    = "snz_new_product_steps";
        String model        = "NewProductStep";
        String desc         = "新品导入步骤信息";
...
//        addQueryFields.add(ImmutableList.of("mould_number"));
//        addQueryFields.add(ImmutableList.of("mould_number", "supplier_code"));
