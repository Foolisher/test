...
public class _17_CompanyVatInvoice_FreeMarkerUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tableName    = "groupon_company_vat_invoices";
        String model        = "CompanyVatInvoice";
        String desc         = "公司增值税发票";
        ...
        addQueryFields.add(ImmutableList.of("company_id"));
