...
public class _14_TQRDCManagerContact_FreeMarkerUtil {

    private static Configuration cfg;

    private static String classpath=_14_TQRDCManagerContact_FreeMarkerUtil.class.getClassLoader().getResource("").getFile();
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO table_name
        String tableName    = "snz_tqrdc_manager_contacts";
        String model        = "TQRDCManagerContact";
        String desc         = "供应商绩效管理者联系方式";
        ...
        addQueryFields.add(ImmutableList.of("name"));
