...
public class _11_ProductOwner_FreeMarkerUtil {

    private static Configuration cfg;

    private static String classpath=_11_ProductOwner_FreeMarkerUtil.class.getClassLoader().getResource("").getFile();
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO table_name
        String tableName    = "snz_product_owners";
        String model        = "ProductOwner";
        String desc         = "产品线负责人及相关工厂信息";
        ...
        addQueryFields.add(ImmutableList.of("product_line_id"));
        addQueryFields.add(ImmutableList.of("product_line_id", "product_line_name"));
