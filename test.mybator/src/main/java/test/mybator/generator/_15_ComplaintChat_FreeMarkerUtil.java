...
public class _15_ComplaintChat_FreeMarkerUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO table_name
        String tableName    = "snz_complaint_chats";
        String model        = "ComplaintChat";
        String desc         = "抱怨信息聊天记录";
        ...
        addQueryFields.add(ImmutableList.of("parent_id"));
